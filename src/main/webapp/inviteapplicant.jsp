...
String fname = "person"; //applicant.getPersonFname();
%>
										...
										<tbody>
											<tr>
												...
												<td align="center"><a target="_blank" href="<%=link %>"> <img width="600" border="0" height="200" alt=""
														style="display: block; border: none; outline: none; text-decoration: none;" src="/images/chipotle-small.png" class="banner"	st-image="banner-image" /></a></td>
											</tr>
										</tbody>
									</table> <!-- end of image -->
								</td>
										...
										<tbody>
											...
											<tr>
												<td align="right" cellpadding="20">
												 <p><a href="<%=link %>"><img src="/images/apply_now_button.png" height="50" width="auto"></img></a></p>
												</td>
											</tr>
										</tbody>
									</table> <!-- end of image -->
														...
														<tbody>
															<tr>
																<td width="390" height="60" align="center"><a
																	target="_blank" href="#"> <img src="/images/emp-logo-sm.png"
