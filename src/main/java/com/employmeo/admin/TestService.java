...
public class TestService {
	...
	public String doMethod() {
		...
		email.addSubstitution("[LINK_TO_RESULTS]",
				new String[] { "https://employmeo.herokuapp.com/respondant_score.jsp?respondant_id=468" });
		...
		try {
			...
			logger.log(Level.INFO,
					"Sent: " + email.getSubject() + "(RC: " + response.getCode() + ") " + response.getMessage());
