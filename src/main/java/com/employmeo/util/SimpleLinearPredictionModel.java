...
public class SimpleLinearPredictionModel implements PredictionModelEngine {

	private static final Logger log = LoggerFactory.getLogger(SimpleLinearPredictionModel.class);
/*
	static {
