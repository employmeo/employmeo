...
public class ICIMSOrder {
	...
	public String doPost (JSONObject json)
	{
		...
		String customerId = json.getString("customerId"); // Customer ID Specifies the ID of the customer
		String userId = json.getString("userId"); // User System ID Specifies the candidate who initiated the request 
