 ...
 * Generated at: 2016-03-29 01:23:44 UTC
...
return;
   ...
   if (fRes !=null) {
     session.removeAttribute("response");
      ...
      out.write("<html>\r\n");
      out.write("<head>\r\n");
      out.write("<title>employmeo | Current Applications</title>\r\n");
      ...
      out.write("\t\t\t\t\t<li><a href=\"/positions.jsp\">Job Definitions</a></li>\r\n");
      out.write("\t\t\t\t\t<li class=\"active\"><a href=\"#\">Current Applications</a></li>\r\n");
      out.write("\t\t\t\t\t<li><a href=\"/analytics.jsp\">Analytics</a></li>\r\n");
      out.write("\t\t\t\t\t<li><a href=\"/data_admin.jsp\">Data Administration</a></li>\r\n");
      out.write("\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t<br>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"panel-heading\">Applicants\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button id=\"applicantrefresh\" class=\"btn-primary pull-right\" type=\"button\" onClick=\"updateRespondantsTable();\"><i class=\"fa fa-refresh\"></i></button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"panel-body\" id=\"respondant_list\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<table id=\"respondants\" class=\"table table-hover table-condensed\"></table>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"panel panel-info\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"panel-heading\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span class=\"text-left\">Position Turnover<i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"fa fa-bar-chart pull-right\"></i></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"panel-body text-center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<canvas id=\"positionTenure\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 100%, height: auto;\"></canvas>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\tupdatePositionProfile();\r\n");
      out.write("\t\t\t\tinitRespondantsTable()\r\n");
      out.write("\t\t\t</script>\r\n");
      out.write("\r\n");
      out.write("\t\t\t");
